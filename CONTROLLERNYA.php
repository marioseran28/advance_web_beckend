...
function hapus_ajax(){
    ...
    function list_po(){
        ...
        INNER JOIN tb_obat ON tb_det_rcv.id_obat=tb_obat.id_obat WHERE status_rcv='AKTIF' AND tb_det_rcv.id_rcv='$id_rcv' AND tb_det_rcv.status_masuk_inv='0'");
    ...
    function list_search(){
        ...
        $hasil=$this->db->query("SELECT * FROM tb_det_rcv 
            ...
            OR tb_det_rcv.qty_obat LIKE '%$search%')");
        //print_r($hasil->result());
        echo json_encode($hasil->result());
    }
