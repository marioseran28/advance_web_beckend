                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">DATA OBAT </h3>
                                ...
                                <div id="form-search">
                                  ...
                                  <tr><td>Show </td> <td>
                                     <div class="input-group">
                                    <select name="limit" id="limit" onchange="datapo();" style="width: 50px" class="form-control">
                              ...
                              </select></div></td><td> Entries</td>
                              <td width='250'></td>
                              <td>Search: </td>
                              <td> <input type="text" onkeyup="datapo()"  name="search" id="search" class="search" placeholder="Search Data"></td></tr>
...
<script type="text/javascript">
    ...
    if (search=="" && id_rcv!=="" && limit!=="") {
        ...
        $.ajax({
            ...
            data:"search="+search+"&id_rcv="+ id_rcv+"&limit="+ limit ,
            success: function(html)
            {
              data = JSON.parse(html);
              isi_tabel = '';
